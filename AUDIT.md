...
- Estado: **NO ejecutado — requiere pantalla** (ver nota del lote-2 abajo)
...
- El diseño A+B del hallazgo sigue vigente y anclado archivo:línea; se ejecuta en la primera sesión con pantalla.
- Verificación pendiente: **[~]** raíz con Música seleccionada, observar la deriva 10 s (dos capturas separadas 5 s con `tools/apple2026_sim_shot.sh`, y a ojo en vivo, que es lo que de verdad delata el tirón).
