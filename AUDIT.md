...
- **Cadencia: hay MENOS despertares que antes, no más.** HZ/6 → HZ/10. El movimiento continuo no sale de despertar más, sino de que cada despertar ahora mueve algo (fracción) en vez de mover 0 dos de cada tres veces. Puertas `lcd_active()` intactas.
