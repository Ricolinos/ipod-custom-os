...
CLAIM_CONTRACTS = {
    "Apple2026.sbs": {
        "required": [
            ...
            ("%Vl(hdr_title,6,0,134,20,3)", "full-screen header title is left aligned so the clock owns the centre"),
            ...
            ("%Vl(hdr_clock,110,0,100,20,8)", "clock is centred on the screen for full-width shells"),
