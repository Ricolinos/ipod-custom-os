...
const unsigned short invadrox_bombs[] = {
...
const struct bitmap bm_invadrox_bombs = { 
    .width = BMPWIDTH_invadrox_bombs, 
    .height = BMPHEIGHT_invadrox_bombs, 
    .format = FORMAT_NATIVE, 
    .data = (unsigned char*)invadrox_bombs,
};
