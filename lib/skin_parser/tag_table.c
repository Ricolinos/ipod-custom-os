...
#define TAG(type,name,param,flag) {(type),sizeof(name),(name "\0" param),(flag)}
    ...
    TAG(SKIN_TOKEN_LIST_TITLE_IS_ROOT,    "Lo" , "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_LIST_TITLE_IS_MUSIC,   "LM" , "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_A26_WPS_MODE,          "Wm" , "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_A26_PLAYLISTS_AVAIL,   "Wp" , "", SKIN_REFRESH_DYNAMIC),
    TAG(SKIN_TOKEN_A26_LYRICS_AVAIL,      "Wl" , "", SKIN_REFRESH_DYNAMIC),
