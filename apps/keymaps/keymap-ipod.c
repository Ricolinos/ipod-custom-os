...
/* Apple2026 (original iPod behaviour): MENU = back one screen, SELECT =
 * enter, PLAY = global play/pause (nothing when idle).  LEFT/RIGHT do not
 * navigate menus. */
static const struct button_mapping button_context_standard[]  = {
    ...
    { ACTION_A26_PLAYPAUSE,     BUTTON_PLAY|BUTTON_REL,             BUTTON_PLAY },
...
static const struct button_mapping button_context_wps[]  = {
    ...
    { ACTION_A26_WPS_MODE,  BUTTON_SELECT|BUTTON_REL,           BUTTON_SELECT },
